...
class RecolorCalculatorV1 : public CalculatorBase {
 public:
  RecolorCalculatorV1() = default;
  ~RecolorCalculatorV1() override = default;
...
// static
absl::Status RecolorCalculatorV1::GetContract(CalculatorContract* cc) {
...
absl::Status RecolorCalculatorV1::Open(CalculatorContext* cc) {
...
absl::Status RecolorCalculatorV1::Process(CalculatorContext* cc) {
  if (use_gpu_) {
#if !MEDIAPIPE_DISABLE_GPU
    MP_RETURN_IF_ERROR(
...
absl::Status RecolorCalculatorV1::Close(CalculatorContext* cc) {
#if !MEDIAPIPE_DISABLE_GPU
...
absl::Status RecolorCalculatorV1::RenderCpu(CalculatorContext* cc) {
...
absl::Status RecolorCalculatorV1::LoadOptions(CalculatorContext* cc) {
...
absl::Status RecolorCalculatorV1::InitGpu(CalculatorContext* cc) {
#if !MEDIAPIPE_DISABLE_GPU
